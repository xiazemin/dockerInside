...
a. 安装 VirtualBox, 不多讲, 因要在它当中创建一个 boot2docker-vm 虚拟
...
curl [https://raw.github.com/steeve/boot2docker/master/boot2docker](https://raw.github.com/steeve/boot2docker/master/boot2docker) &gt; boot2docker; chmod +x boot2docker; sudo mv boot2docker /usr/local/bin
...
curl -o docker [http://get.docker.io/builds/Darwin/x86\_64/docker-latest](http://get.docker.io/builds/Darwin/x86_64/docker-latest); chmod +x docker; sudo cp docker /usr/local/bin
